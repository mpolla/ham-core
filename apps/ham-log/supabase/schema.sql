...
CREATE OR REPLACE VIEW "public"."qso_band_summary" WITH ("security_invoker"='on') AS
 SELECT "qso"."band",
    "count"(*) AS "qso_count"
   FROM "public"."qso"
  GROUP BY "qso"."band";

ALTER TABLE "public"."qso_band_summary" OWNER TO "postgres";

CREATE OR REPLACE VIEW "public"."qso_call_summary" WITH ("security_invoker"='on') AS
 SELECT "l"."call",
    "count"("l"."call") AS "qso_count"
   FROM ("public"."log" "l"
     LEFT JOIN "public"."qso" "q" ON (("l"."id" = "q"."log_id")))
  GROUP BY "l"."call";

ALTER TABLE "public"."qso_call_summary" OWNER TO "postgres";

CREATE OR REPLACE VIEW "public"."qso_cont_summary" WITH ("security_invoker"='on') AS
 SELECT "qso"."cont",
    "count"(*) AS "qso_count"
   FROM "public"."qso"
  GROUP BY "qso"."cont";

ALTER TABLE "public"."qso_cont_summary" OWNER TO "postgres";

CREATE OR REPLACE VIEW "public"."qso_dxcc_summary" WITH ("security_invoker"='on') AS
 SELECT "qso"."dxcc"
   FROM "public"."qso"
  WHERE ("qso"."dxcc" > 0)
  GROUP BY "qso"."dxcc";

ALTER TABLE "public"."qso_dxcc_summary" OWNER TO "postgres";

CREATE OR REPLACE VIEW "public"."qso_grid_summary" WITH ("security_invoker"='on') AS
 SELECT "substring"(("qso"."gridsquare")::"text", 0, 5) AS "grid"
   FROM "public"."qso"
  WHERE ("length"(("qso"."gridsquare")::"text") >= 4)
  GROUP BY ("substring"(("qso"."gridsquare")::"text", 0, 5));

ALTER TABLE "public"."qso_grid_summary" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."qso_mode_summary" WITH ("security_invoker"='on') AS
 SELECT "qso"."mode",
    "count"(*) AS "qso_count"
   FROM "public"."qso"
  GROUP BY "qso"."mode";

ALTER TABLE "public"."qso_mode_summary" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."qso_band_summary" TO "anon";
GRANT ALL ON TABLE "public"."qso_band_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."qso_band_summary" TO "service_role";

GRANT ALL ON TABLE "public"."qso_call_summary" TO "anon";
GRANT ALL ON TABLE "public"."qso_call_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."qso_call_summary" TO "service_role";

GRANT ALL ON TABLE "public"."qso_cont_summary" TO "anon";
GRANT ALL ON TABLE "public"."qso_cont_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."qso_cont_summary" TO "service_role";

GRANT ALL ON TABLE "public"."qso_dxcc_summary" TO "anon";
GRANT ALL ON TABLE "public"."qso_dxcc_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."qso_dxcc_summary" TO "service_role";

GRANT ALL ON TABLE "public"."qso_grid_summary" TO "anon";
GRANT ALL ON TABLE "public"."qso_grid_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."qso_grid_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."qso_mode_summary" TO "anon";
GRANT ALL ON TABLE "public"."qso_mode_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."qso_mode_summary" TO "service_role";
